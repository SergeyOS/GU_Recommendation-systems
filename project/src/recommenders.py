...
class MainRecommender:
    ...
    def _update_dict(self, user_id):
        ...
        if user_id not in self.userid_to_id.keys():
            ...
            self.user_item_matrix = self.user_item_matrix.toarray()
            self.user_item_matrix = coo_matrix(np.vstack((self.user_item_matrix, np.zeros_like(self.user_item_matrix[0]))))
